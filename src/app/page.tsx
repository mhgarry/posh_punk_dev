				...
				<MaxWidthWrapper>
					<div className='py-6 rounded-lg mx-auto text-left flex flex-col bg-background mt-12 shadow-sm items-left max-w-7xl'>
						<div className='flex flex-col text-left'>
							...
							<h2 className='font-semibold text-foreground text-4xl'>Digital Flea Market</h2>
						</div>
							...
							{perks.map((perk) => (
								...
								>
									...
									<CardHeader className='mt-6 md:ml-4 md:mt-0 lg:ml-0 lg:mt-6'>
										...
										<CardContent className='mt-3 text-sm text-muted-foreground sm:p-0'>{perk.description}</CardContent>
									</CardHeader>
								</Card>
							))}
						</div>
